...
- [ ] [16 — Variation table checks](16-variation-table-checks.md) — partial (#136)
- [x] ~~[17 — UFO and Stitcher cleanup](17-ufo-and-stitcher-cleanup.md)~~ ✓ Done (#136)
- [ ] [18 — Generic value and IO checks](18-generic-value-and-io-checks.md) — partial (#136)
...
- [ ] [20 — Variation validator type checks](20-variation-validator-type-checks.md)
- [ ] [21 — XML builder send() → tag!](21-xml-builder-send.md)
- [ ] [22 — Type1Converter font_info fields](22-type1-converter-font-info.md)
- [ ] [23 — Boundary type checks (padding, base_record)](23-boundary-type-checks.md)
- [ ] [24 — Validator dynamic field_key](24-validator-dynamic-field-key.md)
- [ ] [25 — Serialization migration to lutaml-model](25-serialization-migration.md)
- [ ] [26 — Variation preserver spec migration](26-variation-preserver-spec-migration.md)
